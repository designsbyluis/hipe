            ...
            render={({ field }) => (
              <FormItem className="flex flex-col w-full gap-1">
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent className="account-form_input no-focus">
                    <SelectItem value="The City College of New York">The City College of New York</SelectItem>
                    <SelectItem value="Herbert H. Lehman College">Herbert H. Lehman College</SelectItem>
